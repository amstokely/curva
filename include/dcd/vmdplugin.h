 ...
 *  the plugin loading mechanism can find the register, register_tcl, fromNumpy,
...
/*@{*/
/** Error return code for use in the plugin registration and PYTHON_fromNumpy functions */
 ...
 * calling PYTHON_fromNumpy and register.
 */
